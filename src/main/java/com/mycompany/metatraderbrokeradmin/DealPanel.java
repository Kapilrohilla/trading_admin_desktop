...
public class DealPanel extends javax.swing.JPanel {
    ...
    private void tabledata() {
        ...
        String[] columnNames = {"Time", "Login", "Deal", "Symbol", "Volume", "Price", "Reason"};
        ...
        tableModel.addColumn(columnNames[5]);
        ...
        for (int i = 0; i < js.length(); i++) {
            ...
            String deal = jsonObject.getString("_id");
            String volume = jsonObject.getFloat("volume") + "";
            String price = jsonObject.getFloat("price") + "";
            String reason = jsonObject.getString("reason") + "";
            String rowData[] = {time, login, deal, volume, price, reason};
            ...
            public void mouseClicked(MouseEvent e) {
                if (SwingUtilities.isLeftMouseButton(e)) {
                    ...
                    if (e.getClickCount() == 2) {
                        new Orderndealspopup("deals", orderid);
                    }
                }
            }
        });
...
//        new AddSymbol2BidAsk1(0).setVisible(true);
        new PopupTree4Symbol("DealPanel").setVisible(true);
