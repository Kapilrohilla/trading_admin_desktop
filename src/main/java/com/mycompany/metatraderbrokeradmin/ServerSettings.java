...
public class ServerSettings extends javax.swing.JDialog {
    ...
    public ServerSettings() {
        ...
        String api = APIs.GET_ADMIN;
        ApiServices services = new ApiServices();
        JSONObject jso = new JSONObject();
        String adminId = BrokerAdmin.adminId;
        jso.put("adminId", adminId);
        try {
            Response res = services.postDataWithoutToken(api, jso);
            if (res.isSuccessful()) {
                String body = res.body().string();
                System.out.println("body: " + body);
                JSONObject bodyData = new JSONObject(body);
                JSONObject adminData = bodyData.getJSONObject("admin");
                String end_of_day = adminData.getString("end_of_day");
                jTextField1.setText(end_of_day);
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String holidays = jTextField2.getText();
