...
public class CommonPanel extends javax.swing.JPanel {
    ...
    public CommonPanel(JSONObject js) {
        initComponents();
        float status = js.getFloat("status");
        ...
        try {
            volume = js.getFloat("initialVolume") + "";
        ...
        try {
            marginRates = js.getFloat("marginRates") + "";
        } catch (JSONException ex) {
        ...
        try {
            openPrice = js.getFloat("currentPrice") + "";
        } catch (JSONException ex) {
            openPrice = "        ";
        }
        try {
            currentPrice = js.getFloat("currentPrice") + "";
        } catch (JSONException ex) {
            currentPrice = "        ";
        }
        try {
        ...
        jTextField14.setText(marginRates);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Expert Id : ");

        jLabel8.setText("External Id : ");
